...
public class FE_MATTRPosClasses extends FeatureExtractor_ImplBase {

	private int windowSize;
	private String languageCode;

	public FE_MATTRPosClasses(int windowSize, String languageCode) {
