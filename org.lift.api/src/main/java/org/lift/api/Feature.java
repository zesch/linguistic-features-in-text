...
import org.lift.features.util.FeatureNameEscaper;
    ...
    implements Comparable<Feature>
{
    ...
    public Feature(String name, Object value, FeatureType type) throws LiftFeatureExtrationException
    {
     ...
     * 			  in case of an error 
     */
    public Feature(String name, Object value, boolean isDefaultValue, FeatureType type) throws LiftFeatureExtrationException
    {
        this.name = escaper.escape(name);
        this.value = value;
